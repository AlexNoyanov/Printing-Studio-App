  ...
  <div id="app">
    ...
    <nav v-if="isAuthenticated" class="navbar">
      <div class="nav-container">
        ...
        <div class="nav-links">
          <router-link to="/client-home" v-if="userRole === 'user'">Главная</router-link>
          <router-link to="/orders" v-if="userRole === 'user'">Мои заказы</router-link>
          <router-link to="/client-create-order" v-if="userRole === 'user'">Создать заказ</router-link>
          <router-link to="/your-filaments" v-if="userRole === 'user' && hasUserFilaments">Мои материалы</router-link>
          <router-link to="/dashboard" v-if="userRole === 'printer'">Панель управления</router-link>
          <router-link to="/filaments" v-if="userRole === 'printer' && hasPrinterFilaments">Материалы</router-link>
...
// Force Russian language for client version
setCurrentLanguage('ru')
setUserLanguage('ru')
initCurrentLanguage()

// Get initial language - always Russian for client version
const getInitialLanguage = () => {
  // Always return Russian for client version
  return 'ru'
}
...
// For client version, always use Russian
const loadLanguagePreference = () => {
  // Force Russian for client version
