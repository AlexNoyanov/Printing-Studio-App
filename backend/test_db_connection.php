<?php
// Test database connection - Access via browser
// Place this file at: /Apps/Printing/backend/test_db_connection.php
// Access: https://noyanov.com/Apps/Printing/backend/test_db_connection.php
...
try {
    ...
    if ($e->getCode() == 1045) {
        $result['suggestion'] = 'Authentication failed. Grant permissions with: GRANT ALL PRIVILEGES ON printing.* TO \'printing_admin\'@\'%\' IDENTIFIED BY \'vL2tI2sV7c\'; FLUSH PRIVILEGES;';
